      ...
      },
      {
        ...
        detail: {
          ...
          sections: [
            ...
            { title: 'Mijn aanpak', text: 'We hebben een vaste implementatieroute ingericht waarmee kantoren zelfstandig en in een logische volgorde aan de slag kunnen. Via het leerportaal deelden we de benodigde kennis, namen we instructievideo\u2019s op en legden we duidelijk vast welke stappen een kantoor moest doorlopen om SB goed in te richten.\n\nOok het proces daaromheen hebben we uitgewerkt. Daardoor weten klanten wat er van hen wordt verwacht en kunnen we vanuit Servicemanagement sneller ondersteunen wanneer dat nodig is. De kennis zit daarmee niet alleen bij een paar mensen, maar is op een vaste en herhaalbare manier beschikbaar.' },
            { title: 'Resultaat', text: 'Door de vaste aanpak kost een implementatie merkbaar minder tijd en kunnen we klanten sneller en consistenter begeleiden. Vanuit Servicemanagement kunnen we kantoren hierdoor eenvoudiger meenemen in SB en de kennis op een vaste manier overdragen. Van kantoren hebben we veel positieve reacties gekregen over de duidelijkheid van het proces en de manier waarop de kennis wordt aangeboden.' }
          ],
